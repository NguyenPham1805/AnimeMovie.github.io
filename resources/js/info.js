...
const saveBox = document.querySelector('.user-operation .save-box')
const rateBox = document.querySelector('.user-operation .rate-box')
const saveBtn = document.querySelector('.user-operation .save')
const rateBtn = document.querySelector('.user-operation .rate')
const saveBtnClose = document.querySelector('.user-operation .save-box .title .btn-close')
const rateBtnClose = document.querySelector('.user-operation .rate-box .title .btn-close')
const layerUserOP = document.querySelector('.user-operation .layer-cover')

saveBtn.onclick = () => {
    saveBox.style.display = 'block'
    layerUserOP.style.display = 'block'
}
rateBtn.onclick = () => {
...
rateBtnClose.onclick = () => {
    rateBox.style.display = 'none'
    layerUserOP.style.display = 'none'
}
saveBtnClose.onclick = () => {
